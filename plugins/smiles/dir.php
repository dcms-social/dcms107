...
$dir = f_array(query("SELECT * FROM `smile_dir` WHERE `id` = '" . $id . "'"));
...
$k_post = result(query("SELECT COUNT(*) FROM `smile` WHERE `dir` = '$id'"),0);
...
$q = query("SELECT * FROM `smile` WHERE `dir` = '$id' ORDER BY `id` ASC LIMIT $start, $set[p_str]");
