...
if(!isset($_GET['step'])){
 ...
 query("alter table `forum_t` add `vote_close` enum('0','1') default '0'");
 query("alter table `forum_t` add `vote` varchar(32) default NULL");
 query("CREATE TABLE `votes_forum` (
...
query("CREATE TABLE `votes_user` (
 ...
 query("alter table `notes` add `share` enum('0','1') default '0'");
 query("alter table `notes` add `share_type` varchar(12) default 'notes'");
 query("alter table `notes` add `share_id` int(11) default null");
 query("alter table `notes` add `share_id_user` int(11) default null");
 }
 ...
 query("alter table `forum_r` add `opis` varchar(256) default NULL");
 }
 }
