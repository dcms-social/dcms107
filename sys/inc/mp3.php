...
$this->mpeg_ver = "2.5";
$bitrates = f_array(
'1' => f_array(0, 32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, 256, 0),
'2' => f_array(0,  8, 16, 24, 32, 40, 48,  56,  64,  80,  96, 112, 128, 144, 160, 0),
'3' => f_array(0,  8, 16, 24, 32, 40, 48,  56,  64,  80,  96, 112, 128, 144, 160, 0),
);
} else if ($bits[12] == 0) {
$this->mpeg_ver = "2";
$bitrates = f_array(
...
$this->mpeg_ver = "1";
$bitrates = f_array(
'1' => f_array(0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 0),
'2' => f_array(0, 32, 48, 56,  64,  80,  96, 112, 128, 160, 192, 224, 256, 320, 384, 0),
'3' => f_array(0, 32, 40, 48,  56,  64,  80,  96, 112, 128, 160, 192, 224, 256, 320, 0),
);
}
...
$frequency = f_array(
'1' => f_array(
'0' => f_array(44100, 48000),
'1' => f_array(32000, 0),
),
'2' => f_array(
'0' => f_array(22050, 24000),
'1' => f_array(16000, 0),
),
'2.5' => f_array(
'0' => f_array(11025, 12000),
'1' => f_array(8000, 0),
),
);
...
$mode = f_array(
f_array('Stereo', 'Joint Stereo'),
f_array('Dual Channel', 'Mono'),
);
...
$emphasis = f_array(
f_array('none', '50/15ms'),
f_array('', 'CCITT j.17'),
);
$this->emphasis = $emphasis[$bits[30]][$bits[31]];

$samplesperframe = f_array(
'1' => f_array(
'1' => 384,
'2' => 1152,
'3' => 1152
