<?php
  ...
  function create($p_filelist)
  {
    ...
    $v_string_list = f_array();
    $v_att_list = f_array();
    $v_filedescr_list = f_array();
    $p_result_list = f_array();
    if (is_f_array($p_filelist)) {
      if (isset($p_filelist[0]) && is_f_array($p_filelist[0])) {
    ...
    while ($i<$p_size) {
      ...
      switch ($p_options_list[$i]) {
        ...
        case PCLZIP_OPT_BY_NAME :
          ...
          else if (is_f_array($p_options_list[$i+1])) {
  ...
  function privDeleteByRule(&$p_result_list, &$p_options)
  {
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
      $v_header_list[$v_nb_extracted] = f_array();
